...
describe('useMigrationEvents', () => {
  it('accumulates incoming events in order', async () => {
  ...
  it('does not reconnect when the server closes the stream cleanly (code 1000)', async () => {
  ...
  it('stops retrying after max retries and reports exhausted', async () => {
  ...
  it('exposes incrementally-reduced summary alongside the events array', async () => {
    ...
    act(() => socket._msg({ type: 'PlaylistStarted', name: 'P1', trackCount: 7 }))
    act(() =>
      socket._msg({
  ...
  it('ignores malformed WS messages with a console warning', async () => {
  ...
  it('handles 1000 sequential events without breaking', async () => {
